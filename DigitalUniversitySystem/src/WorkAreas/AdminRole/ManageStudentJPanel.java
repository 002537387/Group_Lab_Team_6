 ...
 */
    ...
    public void refreshTable() {
        ...
        for (UserAccount ua : uad.findStudentAccount()) {
            ...
            row[2] = ua.getRole();
            row[3] = ua.getAssociatedPersonProfile().getEmail();
            row[4] = ua.getAssociatedPersonProfile().getContact();
    ...
    private void initComponents() {
        ...
        add(btnNext);
        btnNext.setBounds(500, 250, 80, 23);
        ...
        UserAccountTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "User Name", "Role", "Email", "Contact"
            }
        ) {
